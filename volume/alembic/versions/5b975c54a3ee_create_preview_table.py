...
def upgrade():
    ...
    op.create_table(
        ...
        sa.Column("price_range_suggestion_amount", sa.Integer),
        sa.Column("price_range_suggestion_currency", sa.UnicodeText),
        ...
        sa.Column("price_total_currency", sa.UnicodeText),
        sa.Column("price_shared_cost_amount", sa.Integer),
        sa.Column("price_shared_cost_currency", sa.UnicodeText),
